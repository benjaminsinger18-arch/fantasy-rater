...
export const TIER_INFO = [
  {
    ...
    range: '95–100',
    color: '#E8321A',
    desc: 'Generational asset. First name on any roster — never moves.',
  },
  {
    key: 'cornerstone',
    short: 'CRN',
    ...
    range: '85–94',
    color: '#C8882A',
    desc: 'Elite building block. Rarely trade; anchor of a championship team.',
  },
  {
    key: 'stud',
    short: 'STD',
    ...
    range: '75–84',
    color: '#A88FD8',
    desc: 'Must-start every week. The backbone of a competitive roster.',
  },
  {
    key: 'impact',
    short: 'IMP',
    ...
    range: '60–74',
    color: '#5090D8',
    desc: 'High-upside weekly anchor. Moves fantasy scores on a good day.',
  },
  {
    key: 'starter',
    short: 'STR',
    ...
    range: '45–59',
    color: '#4DC878',
    desc: 'Reliable every-week starter in most league formats.',
  },
  {
    key: 'flex',
    short: 'FLX',
    ...
    range: '30–44',
    color: '#C8D0E0',
    desc: 'Flex-worthy option. Solid bye-week fill-in and streaming target.',
  },
  {
    key: 'bench',
    short: 'BCH',
    ...
    range: '15–29',
    color: '#C4A882',
    desc: 'Depth piece. Start only in emergency or favorable matchup.',
  },
  {
    key: 'waiver',
    short: 'WAV',
    ...
    range: '0–14',
    color: '#666666',
    desc: 'Waiver-wire level. Stream if desperate; likely available in your league.',
  },
] as const;
